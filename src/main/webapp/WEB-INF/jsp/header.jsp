...
<div id="header">
	...
	<header>
		<ul class="siteCateg">
			<li class="on"><a href="https://oku.korea.ac.kr/oku/index.do" target="_blank" title="새창">인재발굴처</a></li>
			<li><a href="http://oia.korea.ac.kr/main.do" target="_blank" title="새창">국제처</a></li>
			<li><a href="https://www.korea.ac.kr/mbshome/mbs/university/index.do" target="_blank" title="새창">카리나대학교</a></li>
		</ul>
  ...
  검색
		...
		<button type="button" class="btn_topSitemap">LOGIN</button>
